    ...
    <div class="parent">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <br><br><br><br>
                <div class="btns">
                    <button class="btn" id="editEmpInfo" onclick="location.href='empEdit.go?emp_no=${emp.emp_no}'">사원정보 수정</button>
