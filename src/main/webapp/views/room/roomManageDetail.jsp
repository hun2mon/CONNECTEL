                                                    ...
                                                    <div class="media pt-3">                                                 
                                                        <div class="media-body">                                                                                                               							                                
								                                ...
								                                <div class="text-right mt-4 mb-5">
								                                    <button class="btn btn-primary btn-sl-sm mr-3" type="button" onclick="roomManageUpdate()"><span class="mr-2"><i class="fas fa-undo"></i></span>수정 </button>								                        
								                                </div>								                            
	                                                        </div>                                                                                                                                                                   
	                                                  	  </div>                                                   
                                                    </div>                                                 
...
<script>
	function roomManageUpdate() {
		location.href="./roomManageUpdate";
	}
</script>
</html>